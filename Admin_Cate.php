            ...
            <table class="table table-hover">
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-default btn-xs" href="TrangAdminCate_Edit.php?id=<?= $row["id_danh_muc"] ?>" role="button">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                </a>
                                <a class="btn btn-danger btn-xs" href="AdminCate_Delete.php?id=<?= $row["id_danh_muc"] ?>" role="button">
